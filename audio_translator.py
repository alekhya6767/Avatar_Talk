#!/usr/bin/env python3
"""
Complete English Audio to Spanish Audio Translation Pipeline.
Optimized for speed using lightweight models.
"""
import sys
import subprocess
...
class AudioTranslator:
    """Complete audio translation pipeline using lightweight models."""
    ...
    def translate_audio(self, input_audio: str, output_audio: str) -> dict:
        ...
        print("🚀 English Audio → Spanish Audio Translation")
        print("=" * 50)
        ...
        try:
            ...
            if success:
                ...
                print(f"   Play with: aplay {mp3_output}")
...
def main():
    ...
    if len(sys.argv) != 3:
        print("Usage: python audio_translator.py <input_audio.mp3> <output_audio.wav>")
        print("Example: python audio_translator.py birthdays.mp3 spanish_output.wav")
        sys.exit(1)
